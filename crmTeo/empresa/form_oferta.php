...
function ofertaPostInsert(&$a){
	...
	//Mando el correo de oferta 

	$correo=$a['fields']['email']['valor'];
	$perfil=$a['fields']['area_id']['valor'];

	$asunto="Aviso Alta Oferta $correo";

	$mensaje="La empresa con email $correo ha puesto una nueva oferta para el perfil $perfil";
