...
require_once "menu.php";
	...
	echo "<tr>";
	echo "<td align=right>";Input($foferta,"fecha");Input($foferta,"duracion","") ;echo "</td>";
	echo "<td align=right>";Input($foferta,"tipo");echo "</td>";
	echo "</tr>\n";

	echo "<tr>";
	echo "<td align=right>";Input($foferta,"num");echo "</td>";
	echo "<td align=right>";Input($foferta,"area_id");echo "</td>";
	echo "</tr>\n";

	echo "<tr>";
	echo "<td align=right>";Input($foferta,"cont","</td><td colspan=3>");echo "</td>";
	...
	echo "<tr>";
	echo "<td align=right>";Input($foferta,"direccion");echo "</td>";
	echo "<td align=right>";Input($foferta,"localidad");Input($foferta,"cpostal","");echo "</td>";
	echo "</tr>\n";


	echo "<tr>";
	echo "<td align=right>";Input($foferta,"provincia");echo "</td>";
	echo "<td align=right>";Input($foferta,"pais");echo "</td>";
	echo "</tr>\n";

	echo "<tr><td class=cabecera colspan=4>Estado de la oferta</td></tr>";
	echo "<tr>";
	echo "<td align=right>";Input($foferta,"estado_emp");echo "</td>";
